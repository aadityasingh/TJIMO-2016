...
\begin{problem}[5 points total]  Prove that the shoelace theorem is consistent when a triangle is rotated by $90\degree$ counterclockwise about the origin. Assume that one vertex remains at the origin. (Hint: $(x, y)$ becomes $(-y, x)$)
\end{problem}
